...
export default function OrderSummaryPage() {
    ...
    const orderCode = "EF-UAO-123";
    const qrCodeSrc = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(orderCode)}`;
    ...
    return (
        <Box sx={{ bgcolor: "#FDF4ED", minHeight: "100vh", p: 3, pb: 10 }}>
            ...
            <RestaurantSection name="" location="" showLocation={false} showMoreButton={false}>
                <Box sx={{ 
                    bg: 'white', 
                    borderRadius: '24px', 
                    p: 2, 
            ...
            {/* Instrucción y QR (solo pedidos en curso) */}
            {isOrderInProgress ? (
